...
export function Coffee({ size = 24, ...props }: Props) {
  return (
    <svg fill="#000000" width={size} height={size} viewBox="0 0 64 64" version="1.1" {...props}
         xmlns="http://www.w3.org/2000/svg"
         style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: '2' }}>
      <g transform="matrix(1,0,0,1,-1024,-256)">
        <rect id="Icons" x="0" y="0" width={size} height={size} />
        <g id="Icons1">
          <g id="Strike">
          </g>
          <g id="H1">
